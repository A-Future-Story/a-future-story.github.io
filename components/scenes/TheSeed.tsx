...
export default function TheSeed() {
  ...
  useEffect(() => {
    ...
    // Fade out hero text as bloom grows
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden">
      ...
      />
      {/* Hero text — fades as bloom grows, transitions into deepening */}
      <div
        ref={textOverlayRef}
        className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none"
      >
        <h1 className="font-serif text-[clamp(3rem,8vw,7rem)] font-semibold text-walnut leading-none mb-3">Skynift</h1>
        <p className="font-sans text-base md:text-lg text-walnut/50 tracking-widest uppercase">Intelligence that grows with you</p>
      </div>
      {/* Scroll indicator */}
